...
class Main {
    public static final Map<String, Map<String, Object>> opts = [
            ...
            q: [longOpt: 'query-string', required: false, args: 1, argName: 'queryString', description:  "Query string that is passed when start on create."],
            ...
            e: [longOpt: 'filter-entry-jobs', required: false, args:  1, argName:  'entryJobRegex', description: "Only jobs matching the regex will be started on create - gradle flag: -DentryJobRegex=<regex>"],
